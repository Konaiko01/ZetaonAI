...
async def get_group_members_from_mongo():
    """
    Conecta ao MongoDB e imprime os membros de todos os grupos.
    """
    ...
    try:
        ...
        # 3. Busca todos os grupos na coleção
        cursor = collection.find({})
        
        group_count = 0
        
        # 4. Itera e imprime os resultados
